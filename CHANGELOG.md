##### [220826]
   - [`File`](/core/$$.File.jsxlib): fixed the `startupAlias` method. It could produce a runtime error _“tt.nudeName is not a function”_ because `File.prototype.resolve()` can sometimes results in a `Folder` object.
